...
public class ListenOrder extends Service implements ChildEventListener {
    ...
    private void showNotification(String key, Request request) {
        ...
        intent.putExtra("userPhone",request.getPhone()); // we cần put user phone, why ? i'll talk late
        ...
        builder.setAutoCancel(true)
                ...
                .setContentInfo("bạn đã order update")
                .setContentText("Order #" +key+"sẽ cập nhật vào status "+ Common.convertCodeToStatus(request.getStatus()))
